...
use crate::sig::curve::eddsa::point_decompress;
use crate::sig::gadgets::nonnative::{CircuitBuilderNonNative, NonNativeTarget};
...
mod tests {
    ...
    use crate::sig::field::ed25519_base::Ed25519Base;
