...
use crate::sig::curve::curve_types::Curve;
...
mod tests {
    ...
    use crate::sig::curve::eddsa::{SAMPLE_MSG1, SAMPLE_PK1, SAMPLE_SIG1};
    use crate::sig::gadgets::eddsa::{fill_circuits, make_verify_circuits};
