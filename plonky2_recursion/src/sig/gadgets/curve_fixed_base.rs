...
use crate::sig::curve::curve_types::{AffinePoint, Curve, CurveScalar};
use crate::sig::gadgets::curve::{AffinePointTarget, CircuitBuilderCurve};
use crate::sig::gadgets::curve_windowed_mul::CircuitBuilderWindowedMul;
use crate::sig::gadgets::nonnative::NonNativeTarget;
use crate::sig::gadgets::split_nonnative::CircuitBuilderSplit;
...
mod tests {
    ...
    use crate::sig::curve::curve_types::{Curve, CurveScalar};
    use crate::sig::curve::ed25519::Ed25519;
    use crate::sig::field::ed25519_scalar::Ed25519Scalar;
    use crate::sig::gadgets::curve::CircuitBuilderCurve;
    use crate::sig::gadgets::curve_fixed_base::fixed_base_curve_mul_circuit;
    use crate::sig::gadgets::nonnative::CircuitBuilderNonNative;
