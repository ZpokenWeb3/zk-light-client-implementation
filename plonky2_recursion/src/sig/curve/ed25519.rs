...
use crate::sig::curve::curve_types::{AffinePoint, Curve, ProjectivePoint};
...
mod tests {
    ...
    use crate::sig::curve::curve_types::{AffinePoint, Curve};
    use crate::sig::curve::ed25519::mul_naive;
