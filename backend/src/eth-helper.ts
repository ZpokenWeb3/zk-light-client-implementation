...
const contractABI = [{
    ...
    "inputs": [{
        ...
        "name": "input",
        "type": "uint256[4]"
    }, {"indexed": false, "internalType": "uint256[4]", "name": "compressedProof", "type": "uint256[4]"}],
    ...
    "inputs": [{
        ...
        "name": "input",
        "type": "uint256[4]"
    }, {"indexed": false, "internalType": "uint256[8]", "name": "proof", "type": "uint256[8]"}],
    ...
    "inputs": [{"internalType": "uint256[4]", "name": "input", "type": "uint256[4]"}, {
        "internalType": "uint256[4]",
        "name": "proof",
        "type": "uint256[4]"
    }], "name": "verifyAndSaveCompressedProof", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{"internalType": "uint256[4]", "name": "input", "type": "uint256[4]"}, {
        "internalType": "uint256[8]",
        "name": "proof",
        "type": "uint256[8]"
    }], "name": "verifyAndSaveProof", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}];
const contract = new web3.eth.Contract(contractABI, contractAddress);

const privateKey =process.env.PRIVATE_KEY as string ;

let web3Account = web3.eth.accounts.privateKeyToAccount('0x' +privateKey);
